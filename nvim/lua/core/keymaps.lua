...
-- Map k (Left) and l (Right)
vim.keymap.set({ "n", "v" }, "h", "h", { silent = true })
vim.keymap.set({ "n", "v" }, "l", "l", { silent = true })
...
-- delete single/multiple character without copying into register
...
-- Close ALL buffers except those with unsaved changes
vim.keymap.set("n", "<leader>ca", ":bufdo bdelete<CR>", opts)
